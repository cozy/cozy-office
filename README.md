[![Travis build status shield](https://img.shields.io/travis/cozy/cozy-office/master.svg)](https://travis-ci.org/cozy/cozy-office)
[![Github Release version shield](https://img.shields.io/github/tag/cozy/cozy-office.svg)](https://github.com/cozy/cozy-office/releases)
...
Hacking the Cozy cozy-office app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/cozy/cozy-office.git
$ cd cozy-office
$ yarn install
```
...
After the build and the stack launched, your app is now available at http://cozy-office.cozy.tools:8080.
...
If you want to work on cozy-office and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for cozy-office is [edas](https://github.com/edas), send him/her a :beers: to say hello!
...
cozy-office is developed by edas and distributed under the [AGPL v3 license][agpl-3.0].
