# How to contribute to Cozy Office?
...
- What is the version of the Cozy Office app?
...
```
$ git clone github.com/cozy/cozy-office.git
$ cd cozy-office
$ git remote add fork git://github.com/yourusername/cozy-office.git
```
...
Go to https://github.com/yourusername/cozy-office and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Cozy Office is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/cozy-office/issues/new
...
[localization]: https://github.com/cozy/cozy-office/blob/master/README.md#localization
